...
class API:
    ...
    def get_last_prediction(self) -> Optional[str]:
        """
    ...
    def _pop(self) -> Optional[APIQueueRequest]:
        """
    ...
    def _post_with_retry(self, endpoint: str, payload: dict[str, Any]) -> Optional[dict]:
        """
