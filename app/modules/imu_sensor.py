import libs.micropython_icm20948.icm20948 as icm20948
...
class IMUSensor:
    ...
    def __init__(
        ...
        self._next_tick_us: int = ticks_us()
    ...
    def wait_next_tick(self) -> None:
        ...
        """
        now = ticks_us()
        dt = ticks_diff(self._next_tick_us, now)
        if dt > 0:
            sleep_us(dt)

        self._next_tick_us = ticks_add(self._next_tick_us, self._period_us)
